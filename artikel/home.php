    ...
    <body>
        ...
        <div id="card"><!-- div id untuk mengambil css card yang sudah kita buat -->
            <div id="card-content"> <!-- div id untuk mengambil css card-content yang sudah kita buat -->
                ...
                <!-- content index utama -->
                <div id="name">    
                        <p class="name-text"><?php echo $_SESSION["user"]["name"] ?></p>
                </div>

                <div id="main">
                    <img src="../img/logo.jpeg" class="logo" alt="UMB"/> <!-- mengambil resource gambar di folder img-->
                    <p class="main-tittle">Tugas Besar 2</p>
                    <p class="main-tittle-a">Pemrogaman Web</p>
                    <p class="main-tittle-b">Dosen: Teuku Achmad Aliansyah, S.Kom, MT</p>
                </div>
